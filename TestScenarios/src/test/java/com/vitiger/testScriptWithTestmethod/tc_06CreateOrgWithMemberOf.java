...
public class tc_06CreateOrgWithMemberOf extends BaseTestClass
{	
	@Test(groups= {"smokeTest"})
	public void CreateOrgWithMemberOfTest() throws Throwable
	...
	//STEP 5 Verification for creation of the Organisation
			...
			utility.waitForElementVisibility(driver,orgf.getSuccessfmsg() );
